...
export function buildMaterialsWorkingMemoryContent(materials: MaterialsLayer1Outline[]): string {
  return [
    ...
    "For questions about what the documents say (names, topics, cross-document), use search_materials first;",
    "use read_materials_section for a known document/section.",
